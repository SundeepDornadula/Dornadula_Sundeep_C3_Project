...
class RestaurantServiceTest {
    ...
    @BeforeEach
    public void initiate_restaurant_and_set_details()
    {
    ...
    //Resetting the resutaurant list to keep it consistent for all the test cases.
    @AfterEach
    public void reset_restaurant_details() {
